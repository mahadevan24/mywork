          ...
          {activeTab === "export" ? (
            <div className="space-y-3">
              <textarea
                readOnly
                value={exportText}
                className="w-full h-64 p-3 text-xs font-mono bg-slate-950 border border-slate-800 rounded-lg text-slate-300 resize-none focus:outline-none"
              />
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-mono text-slate-400 hover:text-rose-400 transition"
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg border border-slate-700 transition"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg transition"
                  >
                    {copied ? (
                      <>
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full h-64 p-3 text-xs font-mono bg-slate-950 border border-slate-800 rounded-lg text-slate-200 placeholder-slate-700 resize-none focus:outline-none focus:border-indigo-500"
              />
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-mono bg-indigo-600 hover:bg-indigo-500 disabled:opacity-40 text-white rounded-lg transition"
                >
